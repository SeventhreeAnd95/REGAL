...
$res=mysqli_query($con,$query);
    ...
    while($row=mysqli_fetch_array($res))
    {
        ...
        echo'<td><button type="button"  class="btn btn-secondary" onclick="editmodal()">Edit</button>&emsp;
                <button type="button" id="delete" class="btn btn-danger" onclick="deleteques()">Delete</button></td>';
         echo'</tr>';
...
if(isset($_POST['deletequestion']))
{
    ...
    $ques_id= $_POST['deletesubtopicid'];
    $query="update regal_questions_list set question='$question' where subtopicid='$ques_id' ";
    $res = mysqli_query($con,$query);
    echo $ques_id;
}

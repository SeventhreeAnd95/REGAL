                    ...
                    if(isset($_GET['topic'])){
                        ...
                        <tr>
                          <th><?php echo $i;?></th>
                            ...
                            <th><button type="button" class="btn btn-secondary" id="theorybtn" onclick="opentheory('<?php echo $rwsql['subtopicid']; ?>')">View Theory</button></th>

                            <th><button type="button" class="btn btn-secondary" onclick="editmodal('<?php echo $rwsql['subtopicid']; ?>')">Edit</button></th>
                            <th><button type="button" class="btn btn-secondary" onclick="deletequestion('<?php echo $rwsql['subtopicid'];?>')">Delete</button></th>
                        </tr>
                        <?php
                        $i++;
                    }
